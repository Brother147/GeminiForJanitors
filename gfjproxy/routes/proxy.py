...
def handle():
    ...
    try:
        ...
        abort(400, "Bad Request. Invalid request payload.")
    ...
    def unlock() -> None:
        try:
            ...
            xlog(user, f"Failed to unlock user storage: {type(e).__name__}")
    ...
    try:
        ...
        except Exception as e:  # noqa: BLE001 - convert unexpected route errors
        ...
        if not stream_cleanup_registered:
            unlock()
